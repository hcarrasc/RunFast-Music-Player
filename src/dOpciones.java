...
public class dOpciones extends JDialog {

    static pantalla pt = new pantalla();
    configuracion cfg = new configuracion();
    public dOpciones(java.awt.Frame parent, boolean modal, pantalla aThis) {
        super(parent, modal);
        initComponents();
        pt = aThis;
        try {
    ...
    public void initElementos() {
        try {
            ...
            Logger.getLogger(dOpciones.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                dOpciones dialog = new dOpciones(new javax.swing.JFrame(), true, pt);
