...
public class pantalla extends javax.swing.JFrame {
    ...
    // Declaracion de atriburos y objetos iniciales
    ...
    public pantalla() {
        ...
        try { initTema();  } catch (FileNotFoundException ex)
           ...
           * ello llama al metodo "setTemaDefault()" del objeto cfg,
           correspondiente a la clase configuracion
           */
        { System.out.println("No existe archivo");
          cfg.setTemaDefault(jList1,eTitulo, eTiempo, eFondoFrame, jSlider1);}

        // Se intenta abrir la configuracion de idioma
        try {initIdioma(); } catch (FileNotFoundException ex)
        {
          /* Si falla la carga del archivo que contiene la configuracion de idioma
           * entonces el programa establecera el idioma español como defecto y lo
           * registrara creando un archivo de texto nuevo con dicha configuracion
           */
          idioma = "español";
    ...
    public void setIconImage() {
        super.setIconImage(BANDEJA.createImage("imagenes/bandejaIcon.png",""));
    }
...
// <editor-fold defaultstate="collapsed" desc="Metodos Geters">
    ...
    private void initJlist() throws FileNotFoundException{
        ...
        total = Directorios.listarDirectorio(directorio,"",grupo,c);
    ...
    // Establece con una imagen inicial la pantalla de reproductor
    ...
    private void eCargarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eCargarMouseClicked
        ...
        String[] grupo = new String[25000];
        int c = 0;
        // Instanciacion de un selector de Directorios/archivos
        JFileChooser selector = new JFileChooser();
        // Se especifica que solamente se mostraran Directorios
        ...
        configuracion guardar = new configuracion();
    ...
    private void eOpcionesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eOpcionesMouseClicked
        ...
        dOpciones dialog = new dOpciones(new javax.swing.JFrame(), true, this);
    ...
    private void eTop5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eTop5MouseClicked
        ...
        Top5 ventanaTop5 = new Top5(new javax.swing.JFrame(),true, this);
    ...
    public void siguiente(){
        ...
        player.p.getGainControl().setLevel(indiceVolumen);
        //BANDEJA.setTrackName(borrador.sustituir(nuevo.getName(),".mp3","", 1), iconoBandeja);
    }
