...
public class TopMusicView extends javax.swing.JDialog {

	private static final long serialVersionUID = 1L;
	String[] masRep = new String[5];
    Configs cfg = new Configs();
    MainAppView pt = new MainAppView();
    /* Creates new form TopMusicView */
    
    public TopMusicView(java.awt.Frame parent, boolean modal,MainAppView aThis) {
        super(parent, modal);
        initComponents();
        this.pt = aThis;
        try {
            ...
            Logger.getLogger(TopMusicView.class.getName()).log(Level.SEVERE, null, ex);
        }
        initLabelsNames();
    }

    private TopMusicView(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TopMusicView dialog = new TopMusicView(new javax.swing.JFrame(), true);
